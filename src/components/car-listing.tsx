      ...
      const dummyCars: Car[] = [
        {
          ...
          year: 2023,
          status: "available",
          images: ["https://source.unsplash.com/featured/?car,bmw"],
          daily_price: 3500,
          fuel_type: "Dizel",
          ...
          engine_power: "190",
          price: 3500,
          features: ["Deri Koltuk", "Sunroof", "Navigasyon"],
          available_from: new Date().toISOString(),
          location_id: 1,
          location_name: "İstanbul",
          location_city: "İstanbul",
          color: "Beyaz",
          description: "Konforlu ve prestijli bir sedan.",
          min_driver_age: 25,
          min_license_years: 3,
        ...
        {
          id: 10002,
          name: "Mercedes E200 2022",
          brand: "Mercedes",
          model: "E200",
          year: 2022,
          status: "available",
          images: ["https://source.unsplash.com/featured/?car,mercedes"],
          daily_price: 4000,
          fuel_type: "Benzin",
          transmission: "Otomatik",
          category: "Sedan",
          ...
          engine_power: "184",
          price: 4000,
          features: ["Deri Koltuk", "Otomatik Park", "LED Farlar"],
          available_from: new Date().toISOString(),
          location_id: 2,
          location_name: "Ankara",
          location_city: "Ankara",
          color: "Siyah",
          description: "Lüks ve güvenli sürüş deneyimi.",
          min_driver_age: 25,
          min_license_years: 3,
          requires_credit_card: true,
          requires_deposit: true,
        ...
        },
        {
          ...
          year: 2021,
          status: "available",
          images: ["https://source.unsplash.com/featured/?car,audi"],
          daily_price: 5000,
          fuel_type: "Dizel",
          transmission: "Otomatik",
          category: "SUV",
          ...
          engine_power: "231",
          price: 5000,
          features: ["4x4", "Panoramik Cam Tavan", "Adaptif Cruise"],
          available_from: new Date().toISOString(),
          location_id: 3,
          location_name: "İzmir",
          location_city: "İzmir",
          color: "Gri",
          description: "Geniş aileler için ideal SUV.",
          min_driver_age: 27,
          min_license_years: 5,
          requires_credit_card: true,
          requires_deposit: true,
        ...
        },
        {
          ...
          year: 2020,
          status: "available",
          images: ["https://source.unsplash.com/featured/?car,volkswagen"],
          daily_price: 2500,
          fuel_type: "Dizel",
          transmission: "Otomatik",
          category: "Sedan",
          ...
          engine_power: "150",
          price: 2500,
          features: ["Otomatik Park", "Isıtmalı Koltuk", "Bluetooth"],
          available_from: new Date().toISOString(),
          location_id: 4,
          location_name: "Bursa",
          location_city: "Bursa",
          color: "Lacivert",
          description: "Şık ve ekonomik sedan.",
          min_driver_age: 23,
          min_license_years: 2,
        ...
        {
          id: 10005,
          name: "Renault Clio 2019",
          brand: "Renault",
          model: "Clio",
          year: 2019,
          status: "available",
          images: ["https://source.unsplash.com/featured/?car,renault"],
          daily_price: 1200,
          fuel_type: "Benzin",
          transmission: "Manuel",
          category: "Hatchback",
          ...
          engine_power: "90",
          price: 1200,
          features: ["Ekonomik", "Bluetooth", "Klima"],
          available_from: new Date().toISOString(),
          location_id: 5,
          location_name: "Antalya",
          location_city: "Antalya",
          color: "Kırmızı",
          description: "Şehir içi kullanım için ideal hatchback.",
          min_driver_age: 21,
          min_license_years: 1,
          requires_credit_card: false,
          requires_deposit: false,
